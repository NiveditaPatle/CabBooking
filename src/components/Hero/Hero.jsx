        ...
        <div className='dark:bg-black/60 bg-white/80 backdrop-blur-sm dark:text-white duration-300 h-[520px] flex'>
            <div className='container grid grid-cols-1 place-items-center'>
                ...
                <div className='text-center space-y-5 py-14'>
                    <p data-aos="fade-up" className='text-primary text-3xl font-semibold uppercase'>
                       Book Cab Now
                    </p>
                    <h1 data-aos="fade-up" data-aos-delay="600"  className='text-4xl md:text-6xl font-bold'>+919993345622</h1>
                    <p data-aos="fade-up" data-aos-delay="1000" className='tracking-[8px] text-base sm:text-xl font-semibold'>
                        www.yourdomain.com
                    </p>
                </div>
                {/* Image section */}
